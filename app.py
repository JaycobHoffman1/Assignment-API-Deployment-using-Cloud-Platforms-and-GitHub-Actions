...
app = Flask(__name__)
ma = Marshmallow(app)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://example_sum_postgres_lj1v_user:BwFVAY3IBEPmbm0N7iAUX4NviAfIU2uO@dpg-cuug1gij1k6c739sbtn0-a.oregon-postgres.render.com/example_sum_postgres_lj1v'
